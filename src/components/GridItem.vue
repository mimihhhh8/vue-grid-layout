...
//                        console.log("### drag end => " + JSON.stringify(newPosition));
            ...
            calcPosition: function (x, y, w, h) {
                ...
                if (this.renderRtl) {
                    ...
                    let topValue = Math.round(this.rowHeight * y + (y + 1) * this.margin[1])
                    let maxHeight = this.$parent.maxHeight
                    let boxHeight = h === Infinity ? h : Math.round(this.rowHeight * h + Math.max(0, h - 1) * this.margin[1])
                    out = {
